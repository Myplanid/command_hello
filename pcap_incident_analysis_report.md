...
### 분석 대상
- **파일명**: `125.6.54.177,125.6.48.241.pcap`
- **파일 크기**: 53,997KB (약 54MB)
- **파일 형식**: libpcap (Magic: d4c3b2a1)
...
| IP 주소 | 위치 | ISP |
|---------|------|-----|
| 125.6.54.177 | 일본 | NTT Communications |
| 125.6.48.241 | 일본 | NTT Communications |
